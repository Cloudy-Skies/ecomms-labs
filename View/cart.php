  ...
  <body>
    <?php
      ...
      if (isset($_SESSION['customer_id'])){
          ...
          $cart = display_cart_ctr($cid);
          $checkOutAmt = cart_value_ctr($cid);

      }else{
          $ipadd = get_real_ip();
          $cart = display_cart_null_ctr($ipadd);
          $checkOutAmt = cart_value_null_ctr($ipadd);
      }
      ...
      <div class="media" style="margin-bottom: 20px">
          ...
          <div class="media-body">
            ...
            <form class="form-inline" method="GET" action="../functions/manage_quantity_cart.php">
              ...
              <a href="<?php echo "./Actions/remove_from_cart.php?id=".$key; ?>" class="btn btn-danger  mb-2">Remove From Cart</a>
            </form>
          </div>
        </div>
              ...
              <tbody>
                <?php
                  ...
                  <td>Ghc <?= $cartItem[3] ?></td>
                    <td>
                        <form class="form-inline" method="GET" action="../Actions/manage_cart_quant.php">
                            ...
                            <a href="<?php echo "../Actions/remove_from_cart.php?id=".$key; ?>" class="btn btn-danger">Remove</a>
                        </form>
